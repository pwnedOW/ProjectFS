	...
	<div id="equipment_item" class="tabcontent">
        <div class="cash_container">
            ...
            <div class="item">
                ...
                <p>파수꾼의 헬름<br><span class="price">4,900</span></p>
            </div>
            
            <div class="item">
                <img src="img/6.png" alt="equipment_item 2">
                <p>파수꾼의 흉갑<br><span class="price">5,900</span></p>
            </div>
            
            <div class="item">
                <img src="img/7.png" alt="equipment_item 3">
                <p>파수꾼의 건틀릿<br><span class="price">3,900</span></p>
            </div>
            
            <div class="item">
                <img src="img/8.png" alt="equipment_item 4">
                <p>파수꾼의 각반<br><span class="price">4,900</span></p>
            </div>

            <div class="item">
                <img src="img/9.png" alt="equipment_item 5">
                <p>흑기사의 헬름<br><span class="price">4,900</span></p>
            </div>
            
            <div class="item">
                <img src="img/10.png" alt="equipment_item 6">
                <p>흑기사의 흉갑<br><span class="price">5,900</span></p>
            </div>
            
            <div class="item">
                <img src="img/11.png" alt="equipment_item 7">
                <p>흑기사의 건틀릿<br><span class="price">3,900</span></p>
            </div>
            
            <div class="item">
                <img src="img/12.png" alt="equipment_item 8">
                <p>흑기사의 각반<br><span class="price">4,900</span></p>
            </div>
            
            <div class="item">
                <img src="img/13.png" alt="equipment_item 9">
                <p>불의 마녀의 헬름<br><span class="price">4,900</span></p>
            </div>
            
            <div class="item">
                <img src="img/14.png" alt="equipment_item 10">
                <p>불의 마녀의 흉갑<br><span class="price">5,900</span></p>
            </div>
            
            <div class="item">
                <img src="img/15.png" alt="equipment_item 11">
                <p>불의 마녀의 건틀릿<br><span class="price">3,900</span></p>
            </div>
            
            <div class="item">
                <img src="img/16.png" alt="equipment_item 12">
                <p>불의 마녀의 각반<br><span class="price">4,900</span></p>
            </div>       
 ...
 <div id="consumption_item" class="tabcontent" style="display:none">
        <div class="cash_container">
            <div class="item">
                ...
                <p>채널 확성기 1개<br><span class="price">300</span></p>
            </div>
            
            <div class="item">
                <img src="img/1,2.png" alt="consumption_item 2">
                <p>채널 확성기 11개<br><span class="price">3,000</span></p>
            </div>
        
            <div class="item">
                <img src="img/3,4.png" alt="consumption_item 3">
                <p>서버 확성기 1개<br><span class="price">700</span></p>
            </div>
            
            <div class="item">
                <img src="img/3,4.png" alt="consumption_item 4">
                <p>서버 확성기 11개<br><span class="price">7,000</span></p>
            </div>
            
            <div class="item">
                <img src="img/20.png" alt="consumption_item 5">
                <p>경험치 부스트 물약<br><span class="price">1,500</span></p>
            </div>
            
            <div class="item">
                <img src="img/21.png" alt="consumption_item 6">
                <p>드랍율 부스트 물약<br><span class="price">1,500</span></p>
            </div>      
        </div>
    </div>
    ...
    <div id="pobability_item" class="tabcontent" style="display:none">
        <div class="cash_container">
            <div class="item">
                ...
                <p>영혼 조각 뽑기 상자 1개<br><span class="price">900</span></p>
            </div>

            <div class="item">
                <img src="img/22,23.png" alt="pobability_item 2">
                <p>영혼 조각 뽑기 상자 11개<br><span class="price">9,000</span></p>
            </div>
        </div>
    </div>
    ...
    <div id="pet_item" class="tabcontent" style="display:none">
        <div class="cash_container">
                <div class="item">
	                ...
	                <p>숲의 위습 펫<br><span class="price">9,900</span></p>
            	</div>
            
	            <div class="item">
	                <img src="img/18.png" alt="pet_item 2">
	                <p>어둠 영혼 펫<br><span class="price">9,900</span></p>
	            </div>
	            
	            <div class="item">
	                <img src="img/19.png" alt="pet_item 3">
	                <p>불꽃 여우 펫<br><span class="price">9,900</span></p>
	            </div>     
            </div>
        </div>
    </div>
