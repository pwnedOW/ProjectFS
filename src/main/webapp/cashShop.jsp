...
<body>
	...
	<div id="equipment_item" class="tabcontent">
        <div class="cash_container">
        	...
        	%>
        		<div class="item">
                <img src="img/<%=DAO.item_no %>.png" alt="equipment_item <%=DAO.item_no %>">
                <p>파수꾼의 헬름</p><br>
                <span class="price"><%=DAO.item_price %></span><br>
            ...
            <div class="item">
                ...
                <p>파수꾼의 헬름</p><br>
                <span class="price" name="itemId" value="<%=%>">4,900</span><br>
				<button onclick="openPurchaseWindow()">구매하기</button>
				<script>
			        function buy_item_action() {
			            window.open('buy_item.jsp');
            ...
            <div class="item">
                ...
                <p>파수꾼의 흉갑</p><br>
                <span class="price" name="itemId" value="<%=%>">5,900</span><br>
                <button onclick="openPurchaseWindow()">구매하기</button>
				<script>
			        function buy_item() {
			            window.open('buy_item.jsp');
